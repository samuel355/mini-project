                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="single-footer f-about">
                                <div class="logo">
                                    <a href="index.html">
                                        <img style="width: 40px; height:" src="assets/images/logo.png" alt="#">
                                    </a>
                                </div>
            ...
            <div class="container">
                <div class="inner-content">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <p class="copyright-owner">Designed and Developed by <a href="pikadrop.com" rel="nofollow" target="_blank"> Mini Project</a>
                        </div>
                    </div>
                </div>
            </div>
