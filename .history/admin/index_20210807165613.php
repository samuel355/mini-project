        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
																...
																<td class="text-right">
																	<div class="dropdown dropdown-action">
																		...
																		<div class="dropdown-menu dropdown-menu-right">
																			...
																			<a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete-modal"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
																		</div>
																	</div>
																</td>
															</tr>
					...
					<!-- Event Modal -->
					<div class="modal custom-modal fade" id="delete-modal">
						<div class="modal-dialog modal-dialog-centered" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title">Are you Sure you want to delete <?php echo $row['firstname']; ?></h5>
								...
								<div class="modal-footer text-center">
									...
									<button type="button" class="btn btn-danger submit-btn" data-dismiss="modal">Delete</button>
								</div>
							</div>
						</div>
					</div>
