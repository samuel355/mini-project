									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input class="form-control" name="firstname" id="firstname" value="<?php echo $r['firstname']?>" type="text">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label class="col-form-label">Last Name</label>
												<input class="form-control" name="lastname" id="lastname" value="<?php echo $r['lastname']?>" type="text">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input class="form-control floating" value="<?php echo $r['email']?>" name="email" id="email" type="email" readonly>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label class="col-form-label">Address</label>
												<input class="form-control" name="user_address" id="user_address" value="<?php echo $r['user_address']?>" type="text">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label class="col-form-label">Phone</label>
												<input class="form-control" value="<?php echo $r['phone']?>" id="phone" name="phone" type="text">
											</div>
										</div>
