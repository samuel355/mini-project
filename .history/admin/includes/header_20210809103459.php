                ...
                <li class="nav-item dropdown">
                    <?php 
                        ...
                        try{
                            ...
                            $fetch = "SELECT COUNT(*) AS numrows FROM messages";
                            $p = $db->prepare($fetch);
                            $p->execute();
                            $pdata = $p->fetch();
                    ...
                    <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                        <i class="fa fa-bell-o"></i> <span class="badge badge-pill"> <?php echo $pdata['numrows'] ?> </span>
                    </a>
                            ...
                            <ul class="notification-list">
                                ...
                                <?php 
                                    ...
                                    try{
                                        ...
                                        $qry = "SELECT * FROM messages ORDER BY id DESC LIMIT 3";
                                        $prep = $db->prepare($qry);
                                        $prep->execute();
