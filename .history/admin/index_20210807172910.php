													...
													try{
														...
														while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
															echo '
																	...
																	<td class="text-right">
																		<div class="dropdown dropdown-action">
																			...
																			<div class="dropdown-menu dropdown-menu-right">
																				...
																				<a class="dropdown-item" href="#" data-toggle="modal" data-target="#'.$row['id'].'"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
																			</div>
																		</div>
																	</td>
																</tr>
																...
																<!-- Event Modal -->
																<div class="modal custom-modal fade" id="delte'.$row['id'].'">
