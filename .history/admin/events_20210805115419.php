            ...
            <div class="page-wrapper">
				...
				<div class="modal fade" id="ModalAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					<div class="modal-dialog" role="document">
						...
						<form id="addEvent-form" class="form-horizontal" method="POST" action="./calender/add-event.php">
								...
								<div class="modal-body">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
										<input type="text" name="title" class="form-control" id="title" placeholder="Title" require>
										</div>
									</div>
									<div class="form-group">
										<label for="description" class="col-sm-2 control-label">Description</label>
										<div class="col-sm-10">
											<input type="text" name="description" class="form-control" id="description" placeholder="Description" require>
										</div>
									</div>
									<div class="form-group">
