										...
										<div class="profile-img-wrap">
											<div class="profile-img">
												<a href="">
													...
													<img  src="<?php echo (!empty($row['photo'])) ? './assets/img/profiles/'.$data['photo'] : './assets/img/profiles/avatar-19.jpg'; ?>" alt="User Image">
												</a>
											</div>
										</div>
											...
											<div class="row">
												<div class="col-md-5">
													<div class="profile-info-left">
														...
														<div class="staff-msg"><a href="#" class="btn btn-custom" data-toggle="modal" data-target="#update-details">Edit Client profile</a></div>
													</div>
												</div>
												<div class="col-md-7">
