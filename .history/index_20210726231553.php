...
<body>
    ...
    <section class="hero-area">
        <div class="container" style="background-image: url('./assets/images/gabbage.png'); width: 100%; height: 300px">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    <div class="hero-image">
                        <img class="main-image img-fluid" src="assets/images/garbage.png" alt="#">
                    </div>
                </div>
            </div>
        </div>
