    ...
    elseif(!preg_match("#[a-z]+#",$_POST["password"])) {
        ...
        if ($mailExits->fetch(PDO::FETCH_ASSOC)) {
            ...
            try {
                ...
                $insert = "INSERT INTO users( firstname, lastname, user_password, email, user_address, registered_on) 
                        VALUES (:firstname, :lastname, :user_password, :email,  :user_address, :registered_on)";
            ...
            echo json_encode('You have Created an account succesfully. Verify email to continue');
