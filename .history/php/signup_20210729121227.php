    ...
    elseif(!preg_match("#[a-z]+#",$_POST["password"])) {
        ...
        if ($mailExits->fetch(PDO::FETCH_ASSOC)) {
            ...
            //TEST MAIL SENDING WITH LOCALHOST AND GMAIL ==============================================
                ...
                $mail->Password   = 'Confirmation12';                               //SMTP password
                ...
                $mail->addAddress('noreply@wastemangement.com');                               //Set email format to HTML
                $mail->Subject = 'Account Activation';
                $mail->Body    =  $email_message + '</b>';
                ...
                if($mail->send()){
                    ...
                    http_response_code(400);
                    $error_message = ''. $mail->Erro
                    echo json_encode('Sorry something went wrong...Contact the system admin');
                }
