                ...
                if($row['numrows'] == 0){
                    ...
                    try{
                        ...
                        $message = "
                            ...
                            <a href='http://localhost/mini-project/reset-link.php?reset_code=".$reset_code."&email=".$email."'> Reset your account</a>
                        ";
                        ...
                        if(!$mail->send()){
                            ...
                            echo json_encode('Link has been sent to your mail');
                            echo '<script>window.location.assign("http://localhost/mini-project/reset-success.php")</script>';
                        }
