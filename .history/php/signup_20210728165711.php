    ...
    elseif(!preg_match("#[a-z]+#",$_POST["password"])) {
        ...
        if ($mailExits->fetch(PDO::FETCH_ASSOC)) {
            ...
            try {
                ...
                $insert = "INSERT INTO users( firstname, lastname, email, usrpassword, usraddress, registered_on) 
                        VALUES (:firstname, :lastname, :email, :usrpassword, :usraddress, :registered_on)";
