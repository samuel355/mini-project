<?php
  ...
  $db = new PDO('mysql:host=localhost;dbname=mini_project', 'root', '');
  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST')
  {
    if(empty($_POST['fullname'])){
      ...
      try{
        ...
        $insert = "INSERT INTO messages (fullname, email, subject_, message_, phone) 
          VALUES (:fullname, :email, :subject_, :message_, :phone)";
        ...
        http_response_code(400);
        echoo json_encode($_SESSION['error']);
      }
