												...
												<div class="col-md-7">
													<ul class="personal-info">
														...
														<li>
															...
															<span class="text"><a href="#"><?php echo (!empty($row['email'])) ? $row['phone'] : 'Update your phone number'; ?></a></span>
														</li>
														<li>
													...
													<div class="staff-msg"><a href="#" class="btn btn-custom">set address</a></div>
												</div>
											</div>
										</div>
									</div>
