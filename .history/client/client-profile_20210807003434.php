								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<form class="form" action="">
											<input
												id="pac-input" class="controls form control"type="text" placeholder="Search Box"/>
											<div id="map"></div>
											<div class="staff-msg"><a href="#" class="btn btn-custom" >set your exact location</a></div>
										</form>
									</div>
								</div>
							</div>
