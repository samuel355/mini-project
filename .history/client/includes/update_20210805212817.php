    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if(empty($_POST["firstname"])){
            ...
            if(!empty($photo)){
                ...
                try {
                    $stmt = $conn->prepare("UPDATE users SET email=:email, password=:password, city=:city, address=:address, digital_address_code=:digital_address_code, country=:country, telephone=:telephone, firstname=:firstname, lastname=:lastname, photo=:photo WHERE id=:id");
