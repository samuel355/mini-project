    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if(empty($_POST["firstname"])){
            ...
            if(!empty($photo)){
                ...
                try {
                    $stmt = $conn->prepare("UPDATE users SET firstname=:firstname, lastname=:lastname, email=:email, user_address=:user_address, phone=:telephone, firstname=:firstname, lastname=:lastname, photo=:photo WHERE id=:id");
