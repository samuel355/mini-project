        ...
        if(empty($_POST["firstname"])){
            ...
            if(!empty($photo)){
                ...
                try {
                    ...
                    $stmt->execute(['email'=>$email, 'password'=>$password, 'city'=>$city, 'user_address'=>$address, 'digital_address_code'=>$digital_address_code, 'country'=>$country, 'telephone'=>$telephone, 'firstname'=>$firstname, 'lastname'=>$lastname, 'photo'=>$filename, 'id'=>$admin['id']]);
