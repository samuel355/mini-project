    ...
    <body>
        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
											...
											<div class="row">
												<div class="col-md-5">
													<div class="profile-info-left">
														...
														<div class="staff-msg"><a href="#" class="btn btn-custom" data-toggle="modal" data-target="#add_event">Edit profile</a></div>
													</div>
												</div>
												<div class="col-md-7">
													...
													<div class="staff-msg"><a href="#" class="btn btn-custom">set you current location</a></div>
												</div>
											</div>
										</div>
									</div>
				...
				<!-- Update Modal-->
				<div id="update-detail" class="modal custom-modal fade" role="dialog">
