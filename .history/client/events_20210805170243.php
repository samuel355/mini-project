						...
						<form id="addEvent-form" class="form-horizontal" method="POST">
								...
								<div class="modal-body">
									...
									<div class="container" >
										...
										<input type="text" value="<?php echo $row['firstname'];?>" name="firstname" id="firstanme">
										<input type="text" value="<?php echo $row['lastname'];?>" name="lastname" id="lastanme">
										<div class="row">
										<div class="form-group">
												<label for="emaili" class="col-sm-12 control-label">email</label>
												<div class="col-sm-12">
													<input type="email" value="<?php echo $email; ?>" name="email" class="form-control" id="email" readonly>
												</div>
											</div>
										</div>
									</div>
