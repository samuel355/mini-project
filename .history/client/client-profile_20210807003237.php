    ...
    <body>
        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<form class="form" action="">
											...
											/>
											<div id="map"></div>
											<div class="staff-msg"><a href="#" class="btn btn-custom" data-toggle="modal">set your exact location</a></div>
										</form>
									</div>
								</div>
							</div>
				...
				<!-- Address Map-->
				<div id="current-location" class="modal custom-modal fade" role="dialog">
					<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Update Your Details</h5>
