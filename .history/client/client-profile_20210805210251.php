									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input class="form-control floating" value="<?php $row['email']?>" name="email" id="email" type="email" readonly>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label class="col-form-label">Address</label>
												<input class="form-control" name="user_address" id="user_address" value="<?php $row['user_address']?>" type="text">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label class="col-form-label">Phone</label>
												<input class="form-control" value="<?php $row['phone']?>" id="phone" name="phone" type="text">
											</div>
										</div>
										
									</div>
									<div class="submit-section">
										<button id="submit" name="submit" class="btn btn-primary submit-btn">Submit</button>
									</div>
								</form>
							</div>
						</div>
