									...
									<div class="profile-view">
										<div class="profile-img-wrap">
											<div class="profile-img">
												<a href="">
													<img style="width: 300px; height: 300px" src="<?php echo (!empty($row['photo'])) ? './assets/img/profiles/'.$row['photo'] : './assets/img/profiles/avatar-19.jpg'; ?>" class="img-fluid" alt="User Image">
												</a>
											</div>
										</div>
											...
											<div class="row">
												<div class="col-md-5">
													<div class="profile-info-left">
														...
														<div class="staff-msg"><a href="#" class="btn btn-custom">Edit profile</a></div>
													</div>
												</div>
												<div class="col-md-7">
