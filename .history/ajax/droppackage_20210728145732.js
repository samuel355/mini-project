 $(function () {
        ...
        function setDestination() {
            ...
            google.maps.event.addListener(from_places, 'address', function () {
        ...
        function appendResults(distance_in_kilo, distance_in_mile, duration_text) {
            ...
            $('#in_kilo').html("Distance in Kilometers : <span class='badge badge-pill badge-secondary'>" + distance_in_kilo.toFixed(2) + "</span>");
            $('#duration_text').html("Duration : <span class='badge badge-pill badge-success'>" + duration_text + "</span>");

            const distance = distance_in_kilo.toFixed(2);
            price = 0;
            if(distance <= 10){
                price = distance * 2;
            ...
            $('#price').html("Price : GHS.  <span class='badge badge-pill badge-success'>" + price + "</span>");
        }

        // send ajax request to save results in the database
        function sendAjaxRequest(origin, destination, distance_in_kilo, distance_in_mile, duration_text, price) {
            $.ajax({
                url: 'common.php',
                type: 'POST',
                data: {
