                                ...
                                <div class="card login-form inner-content">
                                    <div class="card-body">
                                        <div class="alert alert-danger">
                                            <h3 class="align-items-center"><i class="icon fa fa-warning"></i> Error!</h3>
                ...
                <div class="col-lg-6 offset-lg-3 col-md-10 offset-md-1 col-12">
                    ...
                    <div class="card login-form inner-content">
                        <div class="card-body">
                            ...
                            <p>You may <a class="text-success" href="signup.php">Signup</a> or back to <a  class="text-success font-weight-bold" href="index.php">Homepage</a>.</p>
                        </div>
                    </form>
                </div>
            </div>
