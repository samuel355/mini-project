                    ...
                    <div class="nav-inner">
                        ...
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="index.php">
                                <h3 class="text-info">WM</h3>
                            </a>
                            <button class="navbar-toggler mobile-menu-btn pb-1" type="button" data-bs-toggle="collapse"
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        <a href="signin.php" aria-label="Toggle navigation">Login</a>
                                    </li>
                                </ul>
                            </div> <!-- navbar collapse -->
                            <div class="button">
