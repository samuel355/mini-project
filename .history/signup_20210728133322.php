						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div id="process" class="alert alert-primary alert-dismissible fade show" role="alert">
									...
									<div id="succ" class="alert alert-danger alert-dismissible fade show" role="alert">
										<strong id="messages"></strong>
										<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
									</div>
