  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 offset-lg-3 col-md-10 offset-md-1 col-12">
        <form id="signup-form" role="form" name="signup-form" class="card login-form inner-content" method="post">
          <div class="card-body">
            <div class="title">
              <h3>Sign Up Now</h3>
            ...
            <div class="or"><span>Or</span></div>
              ...
              <div class="button">
                <button class="btn" name="submit" type="submit" id="signup">Create Account</button>
              </div>
