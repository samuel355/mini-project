            ...
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-12 col-12 p-3 mb-3">
                    <div class="hero-content">
                        ...
                        <h1 class="wow fadeInUp" data-wow-delay=".4s">We help clean your homes and your communities and homes</h1>
                ...
                <div class="col-lg-7 col-12">
                    <img class="main-image" src="assets/images/garbage.png" alt="#">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        ...
                        <p class="wow fadeInUp" data-wow-delay=".6s">
                            Meet our team. We are up all time to work for your satisfaction.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="single-team">
                    ...
                    <div class="content">
                        <h4>Liza Amoako
                            <span>Chief Executive Director</span>
                        </h4>
                        <ul class="social">
                            <li><a href="javascript:void(0)"><i class="lni lni-facebook-filled"></i></a></li>
                            <li><a href="javascript:void(0)"><i class="lni lni-instagram"></i></a></li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        ...
                        <p class="wow fadeInUp" data-wow-delay=".6s">
                            These are what our customers say about our work delivery.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6 col-12 ">
                    <div class="single-testimonial">
                        <div class="inner-content">
                            ...
                            <div class="text">
                                <p>“They always work on time anytime my dustbin is full”</p>
                            </div>
                            <div class="author">
                                <img src="assets/images/testimonial/testi-1.png" alt="#">
                                <h4 class="name">Elija Boateng
                                <span class="deg">Customer</span>
                                </h4>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-12 ">
                    <div class="single-testimonial">
                        <div class="inner-content">
                            ...
                            <div class="text">
                                <p>“They are very good go be woriking with customers”</p>
                            </div>
                            <div class="author">
                                <img src="assets/images/testimonial/testi-2.png" alt="#">
                                <h4 class="name">David Ammoah
                                <span class="deg">Client</span>
                                </h4>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-12 ">
                    <div class="single-testimonial">
                        <div class="inner-content">
                            ...
                            <div class="text">
                                <p>“I love working with the companey. They are always good.”</p>
                            </div>
                            <div class="author">
                ...
                <div class="col-lg-6 col-12 ">
                    <div class="single-testimonial">
                        <div class="inner-content">
                            ...
                            <div class="text">
                                <p>“I'm so astonned to be working with this prestigeous company”</p>
                            </div>
                            <div class="author">
                                <img src="assets/images/testimonial/testi-2.png" alt="#">
                                <h4 class="name">Wilfred
                                <span class="deg">Customer</span>
                                </h4>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        ...
                        <p class="wow fadeInUp" data-wow-delay=".6s">These are our latest news from our blog. You can explore.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12 wow fadeInUp" data-wow-delay=".4s">
                    <div class="single-blog-grid">
                        <div class="blog-img">
                            ...
                            <img src="assets/images/b1.jpeg" style="width: 100%; height: 300px" alt="#">
                            </a>
                        </div>
                        <div class="blog-content">
                            <div class="meta-info">
                                <a class="date" href="javascript:void(0)"><i class="lni lni-timer"></i> 10 June 2021
                                </a>
                                <a class="author" href="javascript:void(0)"><i class="lni lni-user"></i> Samuel Adu
                                </a>
                            </div>
                            <h4>
                                <a href="#">Faecal Waste Treatment</a>
                            </h4>
                            <p>Our range of services within the sewerage systems & Faecal treatment and management of faecal treatment plants.
                            </p>
                            <div class="button">
                ...
                <div class="col-lg-4 col-md-6 col-12 wow fadeInUp" data-wow-delay=".6s">
                    <div class="single-blog-grid">
                        <div class="blog-img">
                            <a href="#">
                            <img src="assets/images/b2.jpeg" style="width: 100%; height: 300px" alt="#">
                            </a>
                        </div>
                        <div class="blog-content">
                            <div class="meta-info">
                                <a class="date" href="javascript:void(0)"><i class="lni lni-timer"></i> 5 Aug 2020
                                </a>
                                <a class="author" href="javascript:void(0)"><i class="lni lni-user"></i>Emmanuel Boateng
                                </a>
                            </div>
                            <h4>
                                <a href="#">
                            ...
                            <p>A specially designed service in low-to medium income, high density communities and areas to ensure clean communities
                            </p>
                            <div class="button">
                ...
                <div class="col-lg-4 col-md-6 col-12 wow fadeInUp" data-wow-delay=".8s">
                    <div class="single-blog-grid">
                        <div class="blog-img">
                            <a href="blog-single.html">
                                <img src="assets/images/b3.jpeg" style="width: 100%; height: 300px" alt="#">
                            </a>
                        </div>
                        <div class="blog-content">
                            <div class="meta-info">
                                <a class="date" href="javascript:void(0)"><i class="lni lni-timer"></i> 25 Dec 2020
                                </a>
                                <a class="author" href="javascript:void(0)"><i class="lni lni-user"></i> Alex Sandro
                                </a>
                            </div>
                            <h4>
                            <a href="blog-single.html">Covid Fumigation</a>
                            </h4>
                            <p>We deliver all kinds of fumigation processes; offices, homes, schools, etc.</p>
                            <div class="button">
                                <a href="#" class="btn">Read Blog</a>
                            </div>
                        </div>
            ...
            <div class="inner-content">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-5 col-12">
                        <div class="button">
                            <a href="signup.php" class="btn">Get started
                            </a>
                            <a href="about-us.php" class="btn btn-alt">Learn More
                            </a>
                        </div>
                    </div>
                </div>
