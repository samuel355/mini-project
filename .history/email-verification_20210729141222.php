                        ...
                        <div class="card login-form inner-content">
                            <div class="card-body">
                                <div class="alert alert-sucess">
                                    <h4 class="aligns-item-center"><i class="icon fa fa-warning"></i> Hur!</h4>
                                    Account Already activated
                                </div>
                                <p>Login<a class="text-success font-weight-bold" href="signup.php">Signup</a> or back to <a  class="text-success font-weight-bold" href="index.php">Homepage</a>.</p>
                            </div>
                        </div>
                    ';
                }
