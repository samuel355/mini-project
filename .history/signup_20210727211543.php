...
<div class="account-login section">
  <div class="container">
    <div class="row">
      ...
      <!--/notifications-->
        <form id="signup-form" name="signup-form" enctype="multipart/form-data" method="POST">
          <div class="input-head">
            ...
            <div class="row">
              <div class="col-lg-6 col-12">
                <div class="form-group input-group">
                  <label><i class="lni lni-user"></i></label>
                  <input class="form-control" id="username" type="text" placeholder="Your username" required>
                </div>
              </div>
              <div class="col-lg-6 col-12">
                <div class="form-group input-group">
