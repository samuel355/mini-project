...
<html lang="en">
  ...
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Raleway:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">
    ...
    <script defer
            src="https://maps.googleapis.com/maps/api/js?libraries=places&language=en&key=AIzaSyC3jQOcOFgfWrdqFWXvCl3RzsyS_c1DYmY"
            ...
            <div class="col-sm-8">
                ...
                <form id="distance_form">
                    ...
                    <div class="form-group" style="margin-top: 1rem;">
                        ...
                        <input class="form-control" id="from_places" placeholder="Location" required />
                        <input id="origin" name="origin" required="" type="hidden"/>
                    </div>

                    <div class="form-group"><label> Destination : </label>
                        <input class="form-control" id="to_places" placeholder="destination" required />
