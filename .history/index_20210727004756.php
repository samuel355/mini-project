                    ...
                    <div class="nav-inner">
                        ...
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="index.php">
                                <img class="img-fluid" src="assets/images/logo.png" style="width: 30px; height: 30px;" alt="Logo">
                            </a>
                            <button class="navbar-toggler mobile-menu-btn mb-5 p-3" type="button" data-bs-toggle="collapse"
