            ...
            <div class="col-lg-12">
                <div class="nav-inner">
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <button class="navbar-toggler mobile-menu-btn active" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="true" aria-label="navbarSupportedContent">
                            <span class="toggler-icon"></span>
                            <span class="toggler-icon"></span>
                            <span class="toggler-icon"></span>
                        </button>
                        <div class="collapse navbar-collapse sub-menu-bar show" id="navbarSupportedContent">
                            <ul id="nav" class="navbar-nav ms-auto">
                                <li class="nav-item">
                                    <a href="index.php" class="active" aria-label="Toggle navigation">Home</a>
                                </li>
                                <li class="nav-item">
                                    <a href="about-us.php" aria-label="Toggle navigation">About</a>
                                </li>
                                <li class="nav-item">
                                    ...
                                    <ul class="sub-menu collapse" id="submenu-1-1">
                                        ...
                                        <li class="nav-item"><a href="pricing.php">Our Pricing</a></li>
                                        <li class="nav-item"><a href="signin.php">Sign In</a></li>
                                        <li class="nav-item"><a href="signup.php">Sign Up</a></li>
                                        <li class="nav-item"><a href="reset-password.php">Reset Password</a>
                ...
                <div class="inner-content">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-12">
                            <p class="copyright-text">© 2021 WMS - All Rights Reserved</p>
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                            <p class="copyright-owner">Designed and Developed by <a href="https://www.pikadrop.com" rel="nofollow" target="_blank"> Mini Project</a>
                        </div>
                    </div>
                </div>
            </div>
